...
class PermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('administration.permissions.index', compact('modules', 'permissions'));
    }
    ...
    public function assignPermission(Role $role)
    {
        ...
        return view('administration.permissions.assign', compact( 'role', 'permissions', 'modules', 'rolePermissions'));
    ...
    public function assignPermissionToRole(Request $request, Role $role)
    {
        ...
        return redirect()->route('admin.permissions.assign',  $role->id)->with('success', 'Permissions assigned to ' . $role->name . ' successfully');
    }
