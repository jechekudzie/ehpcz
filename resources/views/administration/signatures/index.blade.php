            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0" id="page-title">Signatures</h4>
                ...
                <div class="row">
                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center flex-wrap gap-2">
                                    <div class="flex-grow-1">
                                        ...
                                        <a href="{{route('admin.signatures.index')}}" class="btn btn-info btn-sm add-btn">
                                ...
                                <table style="width: 100%;" id="buttons-datatables"
                                    ...
                                    <tr>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="buttons-datatables"
                                            rowspan="1" colspan="1"
                                            aria-label="Position: activate to sort column ascending"
                                            style="width: 336.4px;">Image Signature
                                        </th>
                                    ...
                                    @foreach($signatures as $signature)
                                        <tr class="even">
                                            ...
                                            <td>
                                                <img src="{{asset($signature->path)}}" alt="{{$signature->name}}" width="100px">
                                            </td>
                                            <td>
                                                <!-- Activate or Deactivate Signature -->
                                                <a href="{{ route('admin.signatures.activate', $signature->slug) }}" class="btn btn-sm  {{ $signature->is_active ? 'btn-danger' : 'btn-success' }}" title="{{ $signature->is_active ? 'Deactivate' : 'Activate' }}">
                                                    <i class="fa fa-power-off"></i>
                                                </a>

                                                <!-- Edit Button -->
                                                <a href="javascript:void(0);" class="edit-button btn btn-sm btn-primary" data-name="{{ $signature->name }}" data-slug="{{ $signature->slug }}" title="Edit">
                                                    <i class="fa fa-pencil"></i>
                                                </a>

                                                <!-- Delete Button -->
                                                <form action="{{ route('admin.signatures.store', $signature->slug) }}" method="POST" onsubmit="return confirm('Are you sure?');" style="display: inline-block;">
                                                    @csrf
                                                    @method('DELETE')
                    ...
                    <div class="col-xxl-3">
                        <div class="card border card-border-light">
                            <div class="card-header">
                                <h6 id="card-title" class="card-title mb-0">Add Signatures</h6>
                            </div>
                            <div class="card-body">
                                <form id="edit-form" action="{{route('admin.signatures.store')}}" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="_method" value="POST">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="name" class="form-label">Name Of Signatory</label>
                                        <input type="text" name="name" class="form-control" id="name"
                                               placeholder="Enter contact type" value="">
                                    </div>
                                    <div class="mb-3">
                                        <label for="name" class="form-label">Signature</label>
