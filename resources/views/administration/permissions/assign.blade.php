            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0" id="page-title">Modules -  - Assign {{$role->name}} Permissions</h4>
                                ...
                                <div class="d-flex align-items-center flex-wrap gap-2">
                                    <div class="flex-grow-1">
                                        ...
                                        <button class="btn btn-success btn-sm" data-bs-toggle="modal"
                                                ...
                                                class="fa fa-plus"></i>  - Assign {{$role->name}} Permissions
                                        </button>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="modal-content border-0">
                                            ...
                                            <div class="card border">
                                                <div class="card-header">
                                                    ...
                                                    <h4 class="card-title mb-0"> Assign {{$role->name}} Permissions</h4>
                                                </div>
                                                <div class="card-body">

                                                    <form action="{{route('admin.permissions.assign-permission-to-role',$role->id)}}" method="POST">
                                                        @csrf
