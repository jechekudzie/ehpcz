                ...
                <div class="row">
                                ...
                                <table style="width: 100%;" id="buttons-datatables"
                                    ...
                                    <tr>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="buttons-datatables"
                                            ...
                                            style="width: 336.4px;">First Name
                                        </th>
                                    ...
                                    @foreach($practitioners as $practitioner)
                                        <tr class="even">
                                            ...
                                            <td>
                                                ...
                                                <!-- Delete Button -->
                                                <form action="{{ route('contact-types.destroy', $practitioner->slug) }}" method="POST" onsubmit="return confirm('Are you sure?');" style="display: inline-block;">
                                                    @csrf
                                                    @method('DELETE')
                    ...
                    <div class="col-xxl-3">
                        <div class="card border card-border-light">
                            <div class="card-header">
                                <h6 id="card-title" class="card-title mb-0">Upload</h6>
                            </div>
                            <div class="card-body">
                                <form id="edit-form" action="{{route('import.practitioners.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="text-end">
                                        <button id="submit-button" type="submit" class="btn btn-primary">Import Practitioner</button>
                                    </div>
                                </form>
